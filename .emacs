...
(custom-set-variables
 ...
 '(package-selected-packages
   '(powershell sublime-themes zenburn-theme glsl-mode cmake-mode go-mode kaolin-themes haskell-mode markdown-mode multiple-cursors smex rust-mode use-package))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 150 :width normal :foundry "outline" :family "Cascadia Mono")))))
...
;; default directory
(setq default-directory "c:/Users/nosferatu" )
